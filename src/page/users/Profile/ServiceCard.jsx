        ...
        <CardContent>
          <div className="   rounded-[25px]   overflow-hidden border  group shadow-custom  w-[300px]">
            <div className="relative h-[200px]">
              <Link to={`/users/event-details/${eventId}?creator=true`}>
                <img
          ...
          {selectedService !== "Past" && (
            <>
              ...
              {status.toLowerCase() === "booked" && (
                <Button>
                  <Link to="/users/create-event">Edit Service</Link>
                </Button>
              )}
              {status.toLowerCase() === "confirmed" && !isPublished && (
              ...
              {status.toLowerCase() === "rejected" && (
                <Button>
                  <Link to="/users/create-event">Change Service</Link>
                </Button>
              )}
            </>
          )}
