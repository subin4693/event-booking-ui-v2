            ...
            <div className="mt-10 flex gap-10 flex-col lg:flex-row flex-wrap">
                <div className="flex-1 space-y-5">
                    ...
                    <div className="bg-input rounded-[25px] max-h-[400px] overflow-hidden  ">
                        <img
                            src={`data:image/jpeg;base64,${details[selectedService]?.images[0]?.data}`}
                ...
                <div className="flex-1">
                    ...
                    {selectedService.toLowerCase() === "decoration" && (
                        <Decoration
                            image1={
                                details[selectedService]?.decorationImages[0]
                            }
                            image2={
                                details[selectedService]?.decorationImages[1]
                            }
                            image3={
                                details[selectedService]?.decorationImages[2]
                            }
                        />
                    )}
                    {/*    {itemName == "catering" && (
